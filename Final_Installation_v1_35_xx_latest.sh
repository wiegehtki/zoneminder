...
echo $(date -u) "02 von 07: Systemupdate und Apache, MySQL und PHP installieren"  | tee -a  ~/FinalInstall.log
                 ...
                 apt -y install libopenblas-dev liblapack-dev libblas-dev libssl-dev
...
echo $(date -u) "03 von 07: Apache konfigurieren, SSL-Zertifikate generieren und Zoneminder installieren"  | tee -a  ~/FinalInstall.log
                 ...
                 apt -y install libcrypt-mysql-perl libyaml-perl libjson-perl libavutil-dev && \
...
echo $(date -u) "05 von 07: Gesichtserkennung und cuDNN installieren"  | tee -a  ~/FinalInstall.log
                 ...
                 if [ "$UBUNTU_VER" = "18.04" ]; then
                    tar -xzvf $CUDNN_VERSION_1804
                 else 
                    if [ "$UBUNTU_VER" = "20.04" ]; then
                        tar -xzvf $CUDNN_VERSION_2004
                    fi
                 fi
                 ...
                 sudo ln libcudnn.so.8.0.5 libcudnn.so.8
                 ...
                 sudo ln libcudnn_adv_infer.so.8.0.5 libcudnn_adv_infer.so.8
                 sudo ln libcudnn_ops_train.so.8.0.5 libcudnn_ops_train.so.8
                 sudo ln libcudnn_cnn_train.so.8.0.5 libcudnn_cnn_train.so.8
                 sudo ln libcudnn_cnn_infer.so.8.0.5 libcudnn_cnn_infer.so.8
                 sudo ln libcudnn_adv_train.so.8.0.5 libcudnn_adv_train.so.8
                 sudo ln libcudnn_ops_infer.so.8.0.5 libcudnn_ops_infer.so.8
...
echo $(date -u) "06 von 07: Gesichtserkennung und cuDNN installieren"  | tee -a  ~/FinalInstall.log
                 ...
                 #opencv compilieren
                 apt -y install python-dev python3-dev build-essential cmake git pkg-config libgtk-3-dev \
...
echo $(date -u) "................................................................................................................." | tee -a  ~/Installation.log
echo $(date -u) "11 von 11: OpenCV mit neuer FFMpeg kompilieren"  | tee -a  ~/Installation.log
                InstallOpenCV
